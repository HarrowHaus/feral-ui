...
function Svg({ className, tone = "acid", size = "md", children, ...props }: FeralOrnamentProps & { children: React.ReactNode }) {
...
function StrokeSvg({ className, tone = "ultra", size = "md", children, ...props }: FeralOrnamentProps & { children: React.ReactNode }) {
...
export function FeralSplat(props: FeralOrnamentProps) { return <Svg {...props}><path d="M47 7c11 0 12 17 19 19 8 3 22-7 27 2 5 10-11 17-10 25 1 9 17 16 10 27-6 9-22-1-30 4-8 4-7 18-19 18-11 0-10-16-18-20-9-5-23 5-28-5-5-11 13-16 13-25S-2 37 4 28c7-9 20 2 28-2 8-4 4-19 15-19Z" /></Svg>; }
export function FeralSplatSmall(props: FeralOrnamentProps) { return <Svg {...props}><path d="M45 14c9-9 17 7 24 8 10 1 14-11 22-3s-6 15-4 24c1 9 13 13 7 23s-18-2-26 2c-8 5-8 18-20 17-10-1-7-15-15-20-7-5-20 5-25-5-5-11 10-13 11-22 1-8-13-14-7-23s20 6 33-1Z" /></Svg>; }
export function FeralBlob(props: FeralOrnamentProps) { return <Svg {...props}><path d="M22 25c15-20 50-18 61 2 14 24-2 55-31 60C19 94 0 55 22 25Z" /></Svg>; }
...
export function FeralArrowLoop(props: FeralOrnamentProps) { return <StrokeSvg {...props}><path d="M20 50c3-31 47-45 71-23 18 17 5 46-19 45-18-1-25-18-13-29" fill="none" /><path d="m55 28 5 22 20-11" fill="none" /></StrokeSvg>; }
...
export function FeralScribbleCircle(props: FeralOrnamentProps) { return <StrokeSvg {...props}><path d="M61 13c32 3 48 31 33 50-20 25-73 19-82-7C3 29 29 11 61 13Z" fill="none" /></StrokeSvg>; }
...
export function FeralPointerHand(props: FeralOrnamentProps) { return <Svg {...props}><path d="M30 49V17c0-7 10-7 10 0v24-29c0-7 10-7 10 0v31-25c0-7 10-7 10 0v30-18c0-7 10-7 10 0v34c0 20-12 31-30 31-13 0-22-8-28-23l-5-14c-3-8 8-13 13-5Z" /></Svg>; }
...
export function FeralLoop(props: FeralOrnamentProps) { return <StrokeSvg {...props}><path d="M24 43c0-22 33-30 49-14 18 18 8 43-18 43-20 0-35-15-26-31 8-15 39-7 62 16" fill="none" /></StrokeSvg>; }
export function FeralCensor(props: FeralOrnamentProps) { return <Svg {...props}><path d="M9 31h82v15H9zM15 57h70v15H15z" /></Svg>; }
export function FeralReceiptTag(props: FeralOrnamentProps) { return <Svg {...props}><path d="M9 17h67l15 16v50l-9-6-9 6-9-6-9 6-9-6-9 6-9-6-9 6Z" /><circle cx="71" cy="31" r="6" fill="currentColor" /></Svg>; }
export function FeralNoiseBadge(props: FeralOrnamentProps) { return <Svg {...props}><path d="M17 17h66v66H17z" /><path d="M29 29h7v7h-7zM46 31h8v8h-8zM63 27h6v6h-6zM34 52h9v9h-9zM57 56h7v7h-7zM70 68h5v5h-5z" fill="currentColor" /></Svg>; }
...
export function FeralTinyGoblin(props: FeralOrnamentProps) { return <Svg {...props}><path d="M17 33 3 17l29 7c12-10 25-10 37 0l28-7-14 16c8 29-8 57-33 57S9 62 17 33Z" /><circle cx="36" cy="49" r="6" fill="currentColor" /><circle cx="64" cy="49" r="6" fill="currentColor" /></Svg>; }
export function FeralStamp({ children, className, tone = "tang", size = "md", label, ...props }: StampProps) { return <span className={cn("feral-stamp", ornamentTone(tone), ornamentSize(size), className)} {...props}>{children ?? label ?? "RECEIPT"}</span>; }
...
export function FeralApprovedStamp(props: StampProps) { return <FeralStamp tone={props.tone ?? "acid"} {...props}>{props.children ?? props.label ?? "APPROVED?"}</FeralStamp>; }
...
export function FeralReceiptStamp(props: StampProps) { return <FeralStamp tone={props.tone ?? "paper"} {...props}>{props.children ?? props.label ?? "RECEIPT"}</FeralStamp>; }

export const feralOrnamentCatalog = [
  "FeralBurst", "FeralBurstRound", "FeralBurstSquare", "FeralSplat", "FeralSplatSmall", "FeralBlob", "FeralArrow", "FeralArrowLeft", "FeralArrowLoop", "FeralArrowWiggle", "FeralScribble", "FeralScribbleCircle", "FeralScribbleUnderline", "FeralWarning", "FeralPointer", "FeralPointerHand", "FeralStar", "FeralStarUgly", "FeralCheck", "FeralX", "FeralLoop", "FeralCensor", "FeralReceiptTag", "FeralNoiseBadge", "FeralCornerSticker", "FeralSpeechScrap", "FeralCrown", "FeralLightning", "FeralEye", "FeralFlame", "FeralDrip", "FeralBracket", "FeralAsterisk", "FeralSpiral", "FeralSkullBubble", "FeralTicket", "FeralPaperclip", "FeralMegaphone", "FeralRadioactive", "FeralTinyGoblin", "FeralWarningLabel", "FeralApprovedStamp", "FeralBadIdeaStamp", "FeralReceiptStamp"
] as const;
